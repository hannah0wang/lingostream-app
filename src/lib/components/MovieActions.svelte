<script lang="ts">
    ...
    // let { overview, vote_average } = movieData;
</script>


<ul class="menu menu-horizontal mt-6 rounded-box bg-base-200 opacity-30 hover:opacity-100 hover:bg-base-300 transition-all duration-300">
