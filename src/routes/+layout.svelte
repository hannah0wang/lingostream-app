...
<div class="navbar max-w-6xl bg-base-100 justify-between mx-auto pt-5" data-theme="sunset">
	<div class="flex-none">
	  <LibraryMenu isLoggedIn={!!session} {data} />
	</div>
	<div class="flex-1">
...
<footer class="text-center text-white bg-accent py-2">
    <p>Made with 
        <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        viewBox="0 0 24 24"
        class="inline-block h-5 w-5 stroke-current mb-1">
        <path
        ...
        <a href="https://github.com/hannah0wang" class="underline">hannah ananas.</a>
        Learn more about this project <a href="/" class="underline">here.</a></p>
</footer>
